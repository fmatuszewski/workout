...
import com.wod.config.ApplicationProperties;
import com.wod.config.DefaultProfileUtil;
...
public class WorkoutApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(WorkoutApp.class);

    private final Environment env;

    public WorkoutApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(WorkoutApp.class);
